document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateResultsCount() {
        const visibleCount = Array.from(tbody.querySelectorAll('tr')).filter(row => row.style.display !== 'none').length;
    ...
    function applySearch() {
        ...
        currentRows.forEach(row => {
            ...
            const statusMatch = currentStatusFilter === 'default' ||
                row.querySelector('.status-badge').className.includes(currentStatusFilter);
    ...
    function applySort() {
        ...
        const hiddenRows = currentRows.filter(row => row.style.display === 'none');
    ...
    sortSelect.addEventListener('change', function () {
        if (['hold', 'interviewed', 'rejected', 'hired', 'default'].includes(this.value)) {
