...
; (function (win, $) {
    ...
    const handleOpenPopup = function () {
        ...
        btnOpenPopup.on("click", function (e) {
            ...
            // إخفي كل الـ modals
            $('.modal .modal_item').removeClass('open')
            $('.modal').removeClass('open')

            // فعّل الـ modal المحدد
            if (modal.length) {
                modal.addClass('open')
                modal.find('.modal_item').addClass('open')
                $('body').addClass('scroll_locked')
            }
        })
    ...
    const handleClosePopup = function () {
        ...
        modal.on('click', function (e) {
            if ($(e.target).hasClass('modal')) {
                $(this).removeClass('open').find('.modal_item').removeClass('open')
                $('body').removeClass('scroll_locked')
            }
        })

        $('.close_popup_btn').on('click', function () {
            $(this).closest('.modal').removeClass('open').find('.modal_item').removeClass('open')
            $('body').removeClass('scroll_locked')
        })
    }
